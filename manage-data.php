...
<head>
    ...
    <meta property="og:title" content="Manage Data" />
                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-0">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center me-3">
                                    <!--begin::Title-->
                                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Manage Data</h1>
                                    <!--end::Title-->
                                    <!--begin::Breadcrumb-->
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <li class="breadcrumb-item text-muted">Manage Data</li>
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                                <!--end::Page title-->
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <!--end::Menu toggle-->
                                        <!--begin::Menu 1-->
                                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_660662b42b909">
                                            <!--begin::Header-->
                                            <div class="px-7 py-5">
                                    ...
                                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                        ...
                                        <div class="card-title">
                                            ...
                                            <div class="d-flex align-items-center position-relative my-1">
                                                ...
                                                <input type="text" data-kt-ecommerce-product-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Search Institution" />
                                            </div>
                                            <!--end::Search-->
                                        </div>
                                        <!--end::Card title-->
                                        ...
                                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                            ...
                                            <a href="add-institution.php" class="btn btn-primary">Add Institution</a>
                                            <!--end::Add Institution-->
                                        </div>
                                        <!--end::Card toolbar-->
                                    </div>
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                            <div class="menu-item px-3">
                                                                <a href="view-data.php" class="menu-link px-3">View</a>
                                                            </div>
                                                            <div class="menu-item px-3">
                                                                <a href="edit-data.php" class="menu-link px-3">Edit</a>
                                                            </div>
                                                        </div>
                                                        <!--end::Menu-->
                                                    </td>
